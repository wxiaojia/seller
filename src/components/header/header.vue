<template>
	<div class="header">
		<div class="content-wrapper">
			...
			<!-- supports是个数组 ，v-if当seller.support为undefine时，下方就不会解析-->
		...
		根据表达式的值的真假切换元素的 display CSS 属性，如果有过渡将触发它。 -->
			<div v-show="detailShow" class="detail">
				<!-- 该层使用css sticky footer ,一个div中分为两层，上面一层内容，下面一层是关闭按钮，当内容过多时关闭的样式还是定位在底部padding-bottom很重要-->
	...
	.content-wrapper
		...
		.content
			...
			.title
				padding:2px 0 8px 0 
				.brand
					display:inline-block  //span不能设置宽高，用inline-block才行
					bg-image('brand')		
					vertical-align:top		
					width:30px
					height:18px
